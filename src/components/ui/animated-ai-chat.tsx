    ...
    const handleSendMessage = () => {
        if (value.trim()) {
            ...
            startTransition(() => {
                ...
                setTimeout(() => {
                    setIsTyping(false);
                    setResponse("Analysis complete. The requested document has been reviewed for compliance risks, key dates, and obligations. Wait-if scenario execution is ready.");
                    setValue("");
                    adjustHeight(true);
                }, 3000);
            });
        ...
        <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none">
            ...
            {response && (
                <motion.div 
                    ...
                    className="w-full max-w-2xl mx-auto mb-8 p-6 backdrop-blur-md bg-white/[0.05] border border-white/[0.1] rounded-2xl shadow-xl z-20"
                >
